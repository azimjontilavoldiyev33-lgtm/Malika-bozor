...
export default function ElonForm({ boshlangich }: { boshlangich?: ElonBoshlangich }) {
  ...
  return (
    <form onSubmit={topshir} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="mb-1 block text-sm font-medium">Xotira</label>
          <input
            value={form.xotira}
        ...
        <div>
          <label className="mb-1 block text-sm font-medium">Rang</label>
          <input
            value={form.rang}
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className="col-span-2">
          <label className="mb-1 block text-sm font-medium">Narx *</label>
          <input
            value={form.narx}
        ...
        <div>
          <label className="mb-1 block text-sm font-medium">Valyuta</label>
          <select
            value={form.valyuta}
      ...
      <div>
        <label className="mb-1 block text-sm font-medium">Rasmlar</label>
